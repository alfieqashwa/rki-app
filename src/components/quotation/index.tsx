  ...
  return (
    <>
      ...
      <section className="mt-4">
        <h3 className="border-4 py-1 text-center text-2xl font-bold uppercase">
          q u o t a t i o n
        </h3>
      </section>
      <section className="mt-4 flex flex-row items-start justify-between">
        ...
        <div className="w-1/4">
          <article className="border-4 px-2 py-1">
      ...
      <section className="mt-4">
        <table className="min-w-full text-left">
          ...
          <tbody>
            {data.map((d) => (
              <tr className="border-b" key={d.no}>
        ...
        <div className="my-8 flex flex-col items-end divide-y-2 font-semibold">
